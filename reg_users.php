...
$result = mysql_query($GET_ALL_ATTENDEES) or die ("Getting entries failed" . mysql_error());
...
while($row = mysql_fetch_array($result)){
    ...
    if($count==1){
    echo " <thead><tr><th>#</th><th>First Name</th><th>Last Name</th><th>Mobile</th><th>Email</th><th>Age</th><th>Gender</th></tr></thead>";
    }
    
echo "<tr><td>" . $count ."</td><td>" . $row['afname']. "</td><td>" . $row['alname'] . "</td><td>" . $row['mobile']. "</td><td>" . $row['email']. "</td><td>" . $row['age'] ."</td><td>" . $row['gender'] ."</td></tr>";
