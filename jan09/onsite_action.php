...
$SQL_ADD_ATTENDEE=$ADD_ONSITE_ATTENDEE . "'" .$_REQUEST['fname'] . "','" . $_REQUEST['lname'] . "','" . $_REQUEST['age'] . "','" .  $_REQUEST['gender'] . "','" . $today . "'," . $_SESSION['userdbid'] . ",'" . $_REQUEST['phnum']."','" . $_REQUEST['email'] ."'," .$price .")";
