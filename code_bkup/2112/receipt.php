...
$mac_calculated = hash_hmac("sha1", implode("|", $data), "f3cf5e94223c4ca4966c2506185fae67");
...
$result22 = mysqli_query($link,$SQL_UPD_PAYMENT1) or die ("local payment insert update failed" . mysql_error());
  ...
  //$sql661="insert into mas_logins(log) values('" . "upd res ". $SQL_UPD_PAYMENT1 . "')" ;
//$result661 = mysqli_query($link,$sql661) or die ("login insert failed" . mysql_error());         
