...
$SQL_ADD_REGS=$ADD_REGS . $_REQUEST['fname'] . "','" . $_REQUEST['lname'] . "','" . $_REQUEST['inputEmail'] . "','" . $_REQUEST['mobnum']. "','" . $_REQUEST['inputPassword'] . "','" . $today . "','" .$_SERVER['REMOTE_ADDR'] . "',\"" . $_REQUEST['address']. "\",'". $_REQUEST['pcode']. "')";
